...
data = pd.read_csv('AllClinical05_normalized.csv')

# Define the target variable ('V03ARTH12' in this case)
target = 'V05ARTH12'
...
# Standardize features (you can use other scaling methods as well)
...
plt.title('Confusion Matrix of Model Trained by 2010 Data')
